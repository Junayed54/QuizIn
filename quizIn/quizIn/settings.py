"""
Django settings for quizIn project.
...
WSGI_APPLICATION = 'quizIn.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'quizIn_database',              # Your database name
        'USER': 'quizIn',                       # Your MySQL username
